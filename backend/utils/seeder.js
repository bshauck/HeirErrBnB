...
const reviewText5 = [
  ...
  "Great accomodations, and very reasonably priced",
...
function getRandomPreviewImageUrl() {
    if (!ExternalVetting1 || !ExternalVetting1.length)
        ExternalVetting1 = [...seedPreviewURLs]
...
function getRandomInteriorImageUrl() {
  if (!ExternalVetting2 || !ExternalVetting2.length)
    ExternalVetting2 = [...seedInteriorURLs]
...
module.exports = { getRandomInt, getRandomInteriorImageUrl, getRandomLocationDescription, getRandomPreviewImageUrl, getReviewInfo, seederBookingIds, seederReviewIds, seederReviewImageIds, seederSpotIds, seederSpotImageIds, seederUserIds, seederUserNames, getFullImages }
